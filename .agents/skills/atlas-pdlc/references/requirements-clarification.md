...
1. Generate the Flow Control's `questionDocumentPattern` from `.pdlc/disciplines/product-management/artifacts/requirements/templates/questions.md`, replacing `{recordId}` with the active POC ID.
