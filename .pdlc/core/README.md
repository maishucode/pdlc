...
This folder contains deterministic, platform-neutral Harness behavior. It may depend on shared schemas, the Stage and Delivery Flow Catalogs, Discipline assets, Project Overlays, and Delivery Records. It must not depend on an Agent platform adapter, platform name, or platform-specific path.
