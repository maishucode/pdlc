...
Changing a Stage can affect every Delivery Flow and every Domain asset that references its id. Follow `pdlc-docs/DELIVERY_FLOW_MODEL.md` and run the Harness validation before merging a change.
